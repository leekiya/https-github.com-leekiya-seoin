...
function the_minimal_scripts() {
    ...
    wp_enqueue_style( 'the-minimal-sidr-light-style', get_template_directory_uri(). '/css/jquery.sidr.light.css' );
    ...
    wp_enqueue_script( 'the-minimal-sidr', get_template_directory_uri() . '/js/jquery.sidr.js', array('jquery'), '2.2.1', true );
