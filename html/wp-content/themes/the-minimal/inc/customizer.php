...
function the_minimal_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
        'the_minimal_animation_speed',
        array(
            'label' => __( 'Animation Speed', 'the-minimal' ),
            'section' => 'the_minimal_slider_settings',
            'type' => 'text',
        )
    );
...
function the_minimal_customize_preview_js() {
	wp_enqueue_script( 'the_minimal_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
